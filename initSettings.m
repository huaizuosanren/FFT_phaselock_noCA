...
settings.msToProcess        = 800; %30000;%37000;        %[ms]
...
settings.IF                 = 15.58e6; %9.548e6;      %[Hz]
settings.samplingFreq       = 62e6; %38.192e6;     %[Hz]
...
% Carrier tracking loop parameters
settings.pllDampingRatio         = 0.7;
settings.pllNoiseBandwidth       = 12;%12;      %[Hz]

settings.fllDampingRatio         = 0.7;
settings.fllNoiseBandwidth       = 7;%7;       %[Hz]
