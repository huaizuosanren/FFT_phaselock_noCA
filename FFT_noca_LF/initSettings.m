...
settings.msToProcess        = 3000; %30000;%37000;        %[ms]
...
settings.IF                 = 20e3; %15.58e6; %9.548e6;      %[Hz]
settings.samplingFreq       =  80e3; %62e6; %38.192e6;     %[Hz]
...
% Carrier tracking loop parameters
settings.pllDampingRatio         = 0.7;
settings.pllNoiseBandwidth       = 6; %12;%12;      %[Hz]

settings.fllDampingRatio         = 0.7;
settings.fllNoiseBandwidth       = 8; % 7;%7;       %[Hz]
%% Navigation solution settings ===========================================

% Period for calculating pseudoranges and position
settings.navSolPeriod       = 800;          %[ms]
